...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentTransaction frgTranc = frgMgr.beginTransaction();

        // change page
        frgTranc.add(new content_main(), "content");
//        frgTranc.replace(R.id.content, new menu(), "fragmentTag");
...
//            Fragment fragment_menu = new menu();
//;
//
//             switch (view.getId()){
//                case R.id.menu_btn:;
//                    fragmentTrans.add(fragment_menu, "fragmentTag");
//                    fragmentTrans.replace(R.id.content_frame, fragment_menu, "fragmentTag");
//                    fragmentTrans.commit();
//                    Log.v("frame", ""+fragmentMgr.executePendingTransactions());
//                break;
